...
mesh = Mesh("./meshes/level1.xml")
V = VectorFunctionSpace(mesh, 'P', 1)
Vspace.append(V)

mesh1 = Mesh("./meshes/level2.xml")
V1 = VectorFunctionSpace(mesh1, 'P', 1)
Vspace.append(V1)

mesh2 = Mesh("./meshes/level3.xml")
V2 = VectorFunctionSpace(mesh2, 'P', 1)
Vspace.append(V2)

mesh3 = Mesh("./meshes/level4.xml")
...
wh = mgcg(A, b, fph, 26, Alist, puse, ruse, 1, nl, 2, 'chebyshev', 'jacobi')
